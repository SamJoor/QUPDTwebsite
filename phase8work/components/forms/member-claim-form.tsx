  ...
  return (
    <div className="surface mx-auto max-w-2xl p-8 md:p-10">
      <div className="mb-6">
        ...
        <p className="mt-4 text-fraternity-slate">Use the email already associated with your alumni record. This creates your alumni account and links it to the chapter directory record so you can manage your own profile.</p>
      </div>
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <Field label="Create a password" hint="Phase 7 uses Supabase email/password auth for member accounts.">
          <Input name="password" type="password" placeholder="At least 8 characters" minLength={8} required />
        </Field>
        <div className="flex flex-wrap items-center gap-4 pt-2">
          <Button className="min-w-40">{state === 'submitting' ? 'Claiming…' : 'Claim profile'}</Button>
          <Button href="/member/login" type="button" variant="secondary">Back to login</Button>
        </div>

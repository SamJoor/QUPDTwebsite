    ...
    <div className="space-y-8 py-2">
      <div className="surface p-8">
        ...
        <p className="mt-4 max-w-3xl text-fraternity-slate">
          Use a single alumni CSV to seed or update directory records. This keeps the project on one table model by extending <strong>alumni_profiles</strong> instead of introducing a separate member table.
        </p>
      </div>
      ...
      <div className="surface p-8 text-sm text-fraternity-slate">
        ...
        <p className="mt-3">
          full_name, email, phone, bond_number, major, graduation_year, graduation_term, member_status,
